...
export const constantRoutes = [{
...

    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: "productCate",
                component: () =>
                    import ("../views/project/productCate/index.vue"),
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/project/productCate/secondMenu.vue')
            },
            {
                path: 'brand',
                name: 'brand',
    ...
    },
    {
        ...
        children: [{
                ...
                name: "marketCoupon",
                component: () =>
                    import ("../../src/views/market/marketCoupon/index"),
            ...
            },
            {
                ...
                name: 'couponDetail',
                component: () =>
                    import ("../../src/views/market/marketCoupon/detail.vue"),
            },
            {
                path: "editCoupon",
                name: "editCoupon",
                component: () =>
                    import ('../../src/views/market/marketCoupon/edit.vue')
            },
            {
                path: 'addCoupon',
                name: 'addCoupon',
                component: () =>
                    import ('../../src/views/market/marketCoupon/add.vue')
            },
            {
                path: "market",
                name: '秒杀活动列表',
                component: () =>
                    import ('@/views/market/active/index.vue'),
    ...
    },
    {
        ...
        component: () =>
            import ("@/views/customary/index.vue"),
        meta: { title: "客服", icon: "customary" },
        children: [{
                path: "default",
                name: "chatDefault",
                component: () =>
                    import ("@/views/customary/default.vue"),
                hidden: true
            },
            {
                path: "chatRoom/:id",
                name: "chatRoom",
                component: () =>
                    import ("@/views/customary/chatRoom.vue"),
                hidden: true,
                props: true
            }
        ]
